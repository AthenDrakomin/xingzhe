...
const SideChannel: React.FC = () => {
  return (
    <div className="fixed left-2 sm:left-3 md:left-6 top-1/2 -translate-y-1/2 z-40 flex flex-col gap-3 sm:gap-4 md:gap-6 animate-fade-in-up md:flex" style={{ animationDelay: '500ms' }}>
