...
const SideChannel: React.FC = () => {
  return (
    <div className="fixed left-3 md:left-6 top-1/2 -translate-y-1/2 z-40 flex flex-col gap-4 md:gap-6 animate-fade-in-up" style={{ animationDelay: '500ms' }}>
      ...
      <ChannelItem href="http://zhengyutouzi.com" label="zhengyutouzi.com">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
          <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18 9 11.25l4.306 4.307a11.95 11.95 0 0 1 5.814-5.519l2.74-1.22m0 0-5.94-2.28m5.94 2.28-2.28 5.941" />
        </svg>
      </ChannelItem>

      <ChannelItem href="http://jiuzhougroup.vip" label="jiuzhougroup.vip">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
